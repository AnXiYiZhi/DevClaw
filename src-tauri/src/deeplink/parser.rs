...
//!
//! Parses devclaw:// URLs into DeepLinkImportRequest structures.
...
/// Parse a devclaw:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// devclaw://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "devclaw" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'devclaw', got '{scheme}'"
        )));
    }
